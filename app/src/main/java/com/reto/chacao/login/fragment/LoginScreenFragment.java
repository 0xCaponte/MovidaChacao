...
public class LoginScreenFragment extends Fragment {
    ...
    /**
     * Handles the necessary permissions and callbacks to link clamour with facebook single sing on
     */
    private void facebookLoginManagement() {
        ...
        mLoginButton.registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onCancel() {
                // App code
                Log.i(TAG, "Se Cancelo la operacion");
            }

            @Override
            public void onError(FacebookException exception) {
                // App code
                Log.i(TAG, "Hubo un error con facebook", exception);
            }
        });
