...
public class CustomDrawable extends Drawable {
    ...
    public CustomDrawable(Drawable base, ComboSeekBar slider, float thumbRadius, List<Dot> dots,
                          int color, int textSize, boolean isMultiline, int lineColor,
                          int dotColor, int selectedColor) {
        ...
        unselectLinePaint.setColor(lineColor);
        unselectLinePaint.setStrokeWidth(toPix(8));

        selectLinePaint = new Paint();
        selectLinePaint.setColor(selectedColor);
        selectLinePaint.setStrokeWidth(toPix(10));

        circleLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        circleLinePaint.setColor(dotColor);
...
//            } else {
            yres = y + mTextHeight + mTextMargin;
//            }
        } else {
