...
public class ComboSeekBar extends SeekBar {
    ...
    public ComboSeekBar(Context context, AttributeSet attrs) {
        ...
        mColorLine = getResources().getColor(R.color.line_background);
        mColorSelected = getResources().getColor(R.color.line_selected_background);
        mColorDot = getResources().getColor(R.color.separator_background);
        ...
        setProgressDrawable(new CustomDrawable(this.getProgressDrawable(), this,
                ...
                mDots,
                mColor,
                mTextSize, mIsMultiline,
                mColorLine,
                mColorDot, mColorSelected));
    ...
    public void setColor(int color) {
        ...
        setProgressDrawable(new CustomDrawable((CustomDrawable) this.getProgressDrawable(), this,
                mThumb.getRadius(), mDots, color, mTextSize, mIsMultiline, mColorLine, mColorDot,
                mColorSelected));
    }
